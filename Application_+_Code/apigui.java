			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (A1.isSelected() && B1.isSelected()) {
					...
					try {
						...
						evaluation.crossValidateModel(j48Classifier, datasetInstances, CrossValidation_Value,new Random(1));
				...
				// Cross validation + RandomForest
					...
					try {
						...
						// Cross Validate Model with user selected folds
						evaluation.crossValidateModel(RandomForestClassifier, datasetInstances, CrossValidation_Value,new Random(1));
				...
				// Cross validation + NaiveBayes
					...
					try {
						...
						// Cross Validate Model with user selected folds
						evaluation.crossValidateModel(NaiveBayesClassifier, datasetInstances, CrossValidation_Value,new Random(1));
				...
				// Cross validation + One Rule
					...
					try {
						...
						// Cross Validate Model with user selected folds
						evaluation.crossValidateModel(OneRClassifier, datasetInstances, CrossValidation_Value,new Random(1));
...
//						textArea.setText(eval.toSummaryString("Test Set + One Rule Evaluation Results : \n"+ "\nPrecision = "+eval.precision(1)+"\nRecall = "+eval.recall(1)+"\nfMeasure = "+eval.fMeasure(1)+"\nError Rate = "+eval.errorRate()+"\n\n", false));
		...
		btnNewButton_2.setBounds(728, 151, 117, 25);
